...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-04 19:49`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f150089c-1606-4b4e-b0aa-c4de6a8309de.git
$ cd f150089c-1606-4b4e-b0aa-c4de6a8309de
```
